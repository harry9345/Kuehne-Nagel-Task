...
🚀 [See The original live](https://windmillui.com/dashboard-react)

I just use the [it as a template please visit for more information](https://github.com/estevanmaito/windmill-dashboard-react.git)
